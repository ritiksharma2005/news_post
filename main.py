"""
main.py
Master Orchestrator for @news.nit_iit (English) - Playwright Scraping Version:
- Zero Paid API Dependencies (No NewsAPI, no LLM, no Flux Image generation)
- Scheduled 8:00 AM IST   -> Morning News Brief (4 posts: 1 Student + 3 Trending)
- Scheduled 6:00 PM IST   -> Evening News Brief (4 posts: 1 Student + 3 Trending)
- Dry Run mode supported  -> Test locally without posting: python main.py --dry-run
"""
...
if __name__ == "__main__":
    ...
    run_pipeline(language="en", run_type=target_run, dry_run=dry_run)